...
export function OnboardingModal({
  ...
  const steps: { title: string; desc: string }[] = !hasMatches
    ...
    : isClient
      ? [
          {
            title: "① パートナーからの日程調整連絡をお待ちください",
            desc: "パートナーから日程調整の連絡が届く予定です。もう少々お待ちください。",
          },
          {
            title: "② 候補日が届いたら ○× で回答してください",
            desc: "「1on1セッション」タブから候補に回答できます。",
          },
        ]
      : [
          {
          ...
          },
          {
            title: "② 日程調整を進めましょう",
            desc:
              "候補日はパートナーからしか送れません。「1on1セッション」タブの調整中セクションから第1回などの候補日を送ってください。",
          },
        ];
